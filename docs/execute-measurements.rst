...
1. Install the SLF3X driver and all required packages as described in :ref:`Installation`.
...
4. Connect the SLF3X sensor to the SEK-SensorBridge
5. Run the example script from the root of the repository.
   ...
   .. sourcecode:: bash
        ...
        python examples/example_usage_sensorbridge_slf3x.py --serial-port <your COM port>
...
.. literalinclude:: ../examples/example_usage_sensorbridge_slf3x.py
    :language: python
...
1. Install the SLF3X driver and all required packages as described in :ref:`Installation`.
2. Connect the SLF3X sensor to the I²C port of your system (for example to the I²C port 1 of a Raspberry Pi).
3. Run the example script from the root of the repository.
   ...
   .. sourcecode:: bash
      ...
      python examples/example_usage_linux_slf3x.py --i2c-port <your I2C port>

Example script
~~~~~~~~~~~~~~

.. literalinclude:: ../examples/example_usage_linux_slf3x.py
    :language: python
